...
\hypertarget{database-consistency-test}{%
...
\hypertarget{select-beam-section}{%
...
\hypertarget{define-the-other-beam-parameters}{%
...
\hypertarget{define-the-deflection-and-stress-equations}{%
